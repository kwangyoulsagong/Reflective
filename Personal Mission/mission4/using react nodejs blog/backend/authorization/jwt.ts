...
function verifyTokenMiddleware(req: AuthRequest, res: Response, next: NextFunction):void{
...
export {generateToken,generateRefreshToken,verifyToken,verifyRefreshToken,verifyTokenMiddleware}