...
import { useLogger } from "../../../libs/hooks/BlockEditor/List/useLogger";
import useListItems from "../../../libs/hooks/BlockEditor/List/useListItems";

const ListEditor = React.memo<ListEditorProps>(
  ({
    block,
    updateBlockContent,
    debouncedUpdateRef,
